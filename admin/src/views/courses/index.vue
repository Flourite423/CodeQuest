  ...
  <div class="courses">
    <div class="header">
      ...
      <div class="header-actions">
        ...
        />
        <el-button type="primary" :icon="Plus" @click="handleCreate">新建课程</el-button>
      </div>
    </div>
    ...
    <template v-else>
      <el-table :data="filteredCourses" style="width: 100%" v-loading="loading">
        ...
        <el-table-column prop="summary" label="课程简介" show-overflow-tooltip />
        ...
        <el-table-column prop="estimated_minutes" label="预计时长(分)" width="120" />
    ...
    <el-dialog v-model="dialogVisible" :title="isCreating ? '新建课程' : '编辑课程'" width="600px">
      <el-form v-if="editingCourse" :model="editingCourse" label-width="100px">
        <el-form-item label="课程代码">
          <el-input v-model="editingCourse.course_code" :disabled="!isCreating" />
        </el-form-item>
        <el-form-item label="课程名称">
          <el-input v-model="editingCourse.title" />
        </el-form-item>
        <el-form-item label="课程简介">
          <el-input v-model="editingCourse.summary" type="textarea" :rows="3" />
        </el-form-item>
        ...
        <el-form-item label="预计时长">
          <el-input-number v-model="editingCourse.estimated_minutes" :min="0" />
        </el-form-item>
