...
<template>
  <div class="users">
    ...
    <div v-else-if="forbidden" class="state-container">
      <el-icon class="state-icon" color="#F56C6C">
        <Warning />
      </el-icon>
    ...
    <div v-else-if="sessionExpired" class="state-container">
      <el-icon class="state-icon" color="#E6A23C">
        <Warning />
      </el-icon>
    ...
    <div v-else-if="users.length === 0" class="state-container">
      <el-icon class="state-icon" color="#909399">
        <Document />
      </el-icon>
        ...
        <el-table-column prop="profile_summary.display_name" label="用户">
          <template #default="{ row }">
            <div class="user-cell">
              ...
              />
              <span>{{ row.profile_summary?.display_name || row.email }}</span>
            </div>
          </template>
        </el-table-column>
    ...
    <el-drawer v-model="drawerVisible" title="用户详情" size="400px">
      <div v-if="selectedUser" class="user-detail">
        ...
        <div class="detail-item">
          ...
          <el-tag>{{
            selectedUser.default_role === "admin" ? "管理员" : "学习者"
          }}</el-tag>
        </div>
        <div class="detail-item">
