...
class CourseController extends BaseController {
  ...
  Future<void> loadCourse() async {
    ...
    try {
      ...
      final mockCourse = _getMockCourse(courseId.value);
      if (mockCourse != null) {
  ...
  Course? _getMockCourse(String id) {
    final mockCourses = <String, Map<String, dynamic>>{
      'mock-course-001': {
        'id': 'mock-course-001',
        'title': 'HTML 基础入门',
    ...
    final mockData = mockCourses[id];
    if (mockData == null) return null;

    return Course.fromDetailJson(mockData);
  }
